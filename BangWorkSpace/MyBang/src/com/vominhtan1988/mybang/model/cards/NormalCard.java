...
public abstract class NormalCard extends Card{
	...
	public NormalCard(String name, String description, Sprite sprite_faceup, String string){
		super(name,description,new Vector2(0,0),sprite_faceup,Resources.getInstance().playcardBack,string);
	}
	public NormalCard(String name,Vector2 location, String description, Sprite sprite_faceup, String string){
