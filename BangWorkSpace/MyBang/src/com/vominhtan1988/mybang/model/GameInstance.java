...
public class GameInstance {
	...
	private GameInstance() {
		...
		player1.playerLocation = new Vector2(0,0);
		...
		player1.isZipHandCard = false;
		players.add(player1);
		
		
		player1 = new Player("Tam");
		player1.playerLocation = new Vector2(420,0);
		...
		player1.playerLocation = new Vector2(840,0);
		player1.setRole(role);
		player1.setCharacter(character);	 			
		players.add(player1);			
		
		player1 = new Player("Tam");
		player1.playerLocation = new Vector2(900,300);
		...
		player1 = new Player("Tam");
		player1.playerLocation = new Vector2(900,400);
		...
		player1 = new Player("Tam");
		player1.playerLocation = new Vector2(400,400);
		...
		player1 = new Player("Tam");
		player1.playerLocation = new Vector2(0,400);
